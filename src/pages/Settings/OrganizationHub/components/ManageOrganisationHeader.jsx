...
const ManageOrganisationHeader = ({ org = {} }) => {
  ...
  return (
    <>
      {/* Sub-Header Tabs Row */}
      <div className="px-2.5 py-1.5 mb-2 rounded-3 border shadow-sm sub-header-nav-bar" style={{ margin: '0 0 0.65rem 0', backgroundColor: 'var(--scada-card)', borderColor: 'var(--scada-border)' }}>
