      ...
      <div className="container-fluid max-w-6xl">
        ...
        <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between pb-3 mb-4 gap-3" style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.12)' }}>
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="fw-bold mb-0 text-white">Policy & Terms Condition</h3>
              <p className="mb-0 small" style={{ color: '#94a3b8' }}>Building Management System (BMS) SCADA Governance & Operational Guidelines</p>
            </div>
          </div>
          ...
          <div className="d-flex align-items-center gap-2">
            <button 
              ...
              style={{ backgroundColor: '#0f172a', border: '1px solid rgba(255, 255, 255, 0.2)' }}
              onClick={handlePrint}
            >
              <Printer size={16} style={{ color: '#38bdf8' }} /> Print Policy
            </button>
            {accepted ? (
              <span 
                className="px-3 py-1.5 rounded-3 d-flex align-items-center gap-1.5 fw-bold font-monospace"
                style={{ backgroundColor: 'rgba(16, 185, 129, 0.2)', color: '#34d399', border: '1px solid rgba(16, 185, 129, 0.4)', fontSize: '12px' }}
              >
        ...
        <div className="row g-3 mb-4">
          <div className="col-sm-6 col-lg-3">
            ...
            >
              <div className="d-flex align-items-center gap-2 mb-1.5 fw-bold small" style={{ color: '#38bdf8' }}>
                <Lock size={16} /> Role-Based Access
              </div>
              <p className="small mb-0" style={{ color: '#cbd5e1' }}>Strict authorization levels for Control Panel operations (Super Admin, Admin, Operator).</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div 
              ...
              style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.1)' }}
            >
              <div className="d-flex align-items-center gap-2 mb-1.5 fw-bold small" style={{ color: '#fbbf24' }}>
                <AlertTriangle size={16} /> Emergency Interlocking
              </div>
              <p className="small mb-0" style={{ color: '#cbd5e1' }}>Fire & Water pump overrides require direct admin confirmation and audit logging.</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div 
            ...
            >
              ...
              <p className="small mb-0" style={{ color: '#cbd5e1' }}>All telemetry readings, daily DPR logs, and command triggers are archived securely for 365 days.</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div 
              ...
              style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.1)' }}
            >
              <div className="d-flex align-items-center gap-2 mb-1.5 fw-bold small" style={{ color: '#34d399' }}>
                <ShieldCheck size={16} /> Uptime Commitment
              </div>
              <p className="small mb-0" style={{ color: '#cbd5e1' }}>99.9% uptime target for critical electrical, HVAC, and alarm telemetry dispatchers.</p>
            </div>
          </div>
        </div>

        {/* Tab Selection */}
        <div className="d-flex flex-wrap gap-2 mb-4 pb-2" style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.12)' }}>
          <button
            className="btn btn-sm px-3 py-2 fw-semibold rounded-3 transition-all d-flex align-items-center gap-1.5"
            style={{
              backgroundColor: activeTab === 'terms' ? '#0284c7' : '#0f172a',
              color: activeTab === 'terms' ? '#ffffff' : '#cbd5e1',
          ...
          <button
            className="btn btn-sm px-3 py-2 fw-semibold rounded-3 transition-all d-flex align-items-center gap-1.5"
            style={{
              backgroundColor: activeTab === 'privacy' ? '#0284c7' : '#0f172a',
              color: activeTab === 'privacy' ? '#ffffff' : '#cbd5e1',
              border: '1px solid rgba(255, 255, 255, 0.15)'
            }}
          ...
          <button
            className="btn btn-sm px-3 py-2 fw-semibold rounded-3 transition-all d-flex align-items-center gap-1.5"
            style={{
              backgroundColor: activeTab === 'security' ? '#0284c7' : '#0f172a',
              color: activeTab === 'security' ? '#ffffff' : '#cbd5e1',
              border: '1px solid rgba(255, 255, 255, 0.15)'
            }}
          ...
          <button
            className="btn btn-sm px-3 py-2 fw-semibold rounded-3 transition-all d-flex align-items-center gap-1.5"
            style={{
              backgroundColor: activeTab === 'sla' ? '#0284c7' : '#0f172a',
              color: activeTab === 'sla' ? '#ffffff' : '#cbd5e1',
              border: '1px solid rgba(255, 255, 255, 0.15)'
            }}
        ...
        >
          {activeTab === 'terms' && (
            <div>
              <h4 className="fw-bold text-white mb-3">1. Terms & Conditions of Operation</h4>
              ...
              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>1.1 Authorized Usage & Operator Integrity</h6>
              ...
              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>1.2 Equipment Command Executions</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
              ...
              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>1.3 Modifications & Template Settings</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
          ...
          {activeTab === 'privacy' && (
            <div>
              <h4 className="fw-bold text-white mb-3">2. Privacy & Data Handling Policy</h4>
              <p className="leading-relaxed" style={{ color: '#cbd5e1' }}>
                We prioritize operational data integrity and facility telemetry privacy across all connected devices and sensor networks.
              </p>

              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>2.1 Telemetry Data Collection</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
              ...
              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>2.2 Data Encryption & Retention</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
          ...
          {activeTab === 'security' && (
            <div>
              <h4 className="fw-bold text-white mb-3">3. System Control & Security Protocol</h4>
              <p className="leading-relaxed" style={{ color: '#cbd5e1' }}>
                Industrial control system safety is enforced through hardware and software interlocking mechanisms.
              </p>

              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>3.1 Fail-Safe Emergency Protocols</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
              ...
              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>3.2 Impersonation & Audit Monitoring</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
          ...
          {activeTab === 'sla' && (
            <div>
              <h4 className="fw-bold text-white mb-3">4. Service Level Agreement (SLA)</h4>
              <p className="leading-relaxed" style={{ color: '#cbd5e1' }}>
                Service availability and maintenance conditions for high-availability SCADA operations.
              </p>

              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>4.1 Availability Guarantee</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
                The system targets 99.9% platform availability for alarm telemetry dispatches and real-time dashboard visualization.
              </p>

              <h6 className="fw-bold mt-4 mb-2" style={{ color: '#38bdf8' }}>4.2 Scheduled Maintenance Windows</h6>
              <p className="small" style={{ color: '#cbd5e1' }}>
          ...
          <div 
            className="mt-4 pt-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 p-3 rounded-3"
            style={{ backgroundColor: '#0f172a', borderTop: '1px solid rgba(255, 255, 255, 0.12)' }}
          >
            <div className="small" style={{ color: '#94a3b8' }}>
              Have questions regarding system policies or operational compliance?
              <br />
              <span className="text-white">Contact Facility Security Admin: <strong>compliance@bms-control.com</strong></span>
            </div>
            {!accepted && (
              <button 
