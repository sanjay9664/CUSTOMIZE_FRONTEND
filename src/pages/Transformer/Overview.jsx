  ...
  return (
    <div className="fade-in">
      <div className="page-header">
        <div>
          <h2 className="mb-1" style={{ color: 'var(--scada-text)' }}>Transformer Monitoring</h2>
      ...
      <Row className="g-4 mb-4">
        <Col lg={6}>
          <Card className="scada-card border">
             <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h4 className="fw-bold mb-0" style={{ color: 'var(--scada-text)' }}>Transformer #1</h4>
                ...
                <Row className="text-center g-3">
                  <Col xs={4}>
                    <div className="p-3 rounded border" style={{ backgroundColor: 'var(--scada-input-bg)', borderColor: 'var(--scada-border)' }}>
                      ...
                      <h5 className="mb-0" style={{ color: 'var(--scada-text)' }}>11.2</h5>
                  ...
                  <Col xs={4}>
                    <div className="p-3 rounded border" style={{ backgroundColor: 'var(--scada-input-bg)', borderColor: 'var(--scada-border)' }}>
                      ...
                      <h5 className="mb-0" style={{ color: 'var(--scada-text)' }}>62°C</h5>
                  ...
                  <Col xs={4}>
                    <div className="p-3 rounded border" style={{ backgroundColor: 'var(--scada-input-bg)', borderColor: 'var(--scada-border)' }}>
                      ...
                      <h5 className="mb-0" style={{ color: 'var(--scada-text)' }}>84%</h5>
                      <small className="text-muted">Efficiency</small>
                    </div>
                  </Col>
                </Row>

                <div className="mt-4 p-3 rounded border" style={{ backgroundColor: 'var(--scada-input-bg)', borderColor: 'var(--scada-border)' }}>
        ...
        <Col lg={6}>
          <Card className="scada-card border">
             <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h4 className="fw-bold mb-0" style={{ color: 'var(--scada-text)' }}>Transformer #2</h4>
      ...
      <div className="scada-card mt-4 border">
        <h6 className="mb-4" style={{ color: 'var(--scada-text)' }}>Power Quality Monitoring</h6>
        <Row className="g-4">
            {[
                ...
                <Col md={3} key={idx}>
                    <div className="p-3 rounded border" style={{ backgroundColor: 'var(--scada-input-bg)', borderColor: 'var(--scada-border)' }}>
                        ...
                        <div className="d-flex justify-content-between align-items-end">
                            <span className="fw-bold fs-5" style={{ color: 'var(--scada-text)' }}>{item.value}</span>
